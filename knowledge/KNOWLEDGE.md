...
| [hysteresis-for-self-recording-cleanup](./hysteresis-for-self-recording-cleanup.md) | `feedback` | A cleanup that writes its own receipt needs two thresholds, or it never settles |
| [falsify-the-gate](./falsify-the-gate.md) | `feedback` | A safety test never seen to fail proves nothing — break what it guards, watch it go red, restore. Re-falsify when it moves |
